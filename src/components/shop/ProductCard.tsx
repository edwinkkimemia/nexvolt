...
export function ProductCard({ product }: { product: any }) {
  ...
  return (
    <div className="group relative rounded-2xl border border-zinc-200 bg-white p-3 flex flex-col hover:shadow-lg hover:border-zinc-300 transition">
      ...
      <Link href={`/shop/${product.slug}`} className="aspect-[4/3] rounded-xl overflow-hidden bg-zinc-50 grid place-items-center p-4">
        <img src={product.image} alt={product.name} className="h-full w-full object-contain group-hover:scale-105 transition duration-500"/>
      </Link>
